// 服務條款 / 隱私權政策的純文字資料。與 UI 分離，方便日後法務直接改文字。
export type LegalDoc = 'terms' | 'privacy'

type LegalSection = { heading: string; items: string[] }
type LegalContent = { title: string; sections: LegalSection[] }

export const termsDocument: LegalContent = {
  title: '服務條款',
  sections: [
    {
      heading: '一、服務性質與適用範圍',
...
export const privacyDocument: LegalContent = {
  title: '隱私權政策',
  sections: [
    {
...
export function getLegalContent(type: LegalDoc): LegalContent {
